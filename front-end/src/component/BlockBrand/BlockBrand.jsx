...
const BlockBrand = () => {
  return (
    <div className="brand max-w-screen-2xl px-[17.5px] py-[27px] flex flex-col gap-[20px] md:px-[85px] md:py-[35px] lg:px-[130px] lg:py-[40px] xl:py-[60px]">
      <div className="flex flex-row items-center justify-between">
        ...
        <img src={brandCoinGecko} alt="brandCoinGecko" className="tql-brand-img"/>
      </div>
      <div className="flex flex-row items-center justify-around">
        <img src={brandBlockChain} alt="brandBlockChain" className="tql-brand-img"/>
        <img src={brandOkCoin} alt="brandOkCoin" className="tql-brand-img"/>
        <img src={brandBeInCrypto} alt="brandBeInCrypto" className="tql-brand-img"/>
      </div>
    </div>
  );
};
